...
//Don't touch me!
//#Add
recipes.addShapeless("enchantedMetal",<simpleores:mythril_ingot> * 2, [<contenttweaker:lapis_shards>,<minecraft:silver_ingot>,<minecraft:iron_ingot>,<contenttweaker:lapis_shards>]);
recipes.addShapeless("powerfulAlloy",<simpleores:mythril_ingot> * 2, [<contenttweaker:strange_metal>,<minecraft:gold_ingot>,<minecraft:iron_ingot>,<contenttweaker:strange_metal>]);
